...
os.chdir("E:/projects/Multilingual-OCR-main") #change path 
file_path="E:/projects/Multilingual-OCR-main/input_images"
...
file=r'E:\projects\Multilingual-OCR-main\output_unformatted.txt'
os.startfile(file)